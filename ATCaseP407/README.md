This is my first attempt at designing and printing something larger than a simple clothes hook, so it’s not perfect and has a few minor design quirks. 
Still, it’s a straightforward, compact case for a retro PC. Feel free to explore, adapt, or improve it for your own build.
...
- Filament used: Elegoo Rapid PLA+ (50.203.0314).
...
Limitations
- Designed around the BEK-tronic BEK-P407 motherboard ([link](https://theretroweb.com/motherboards/s/bek-tronic-bek-p407)), so maximum supported board size is 220 mm × 220 mm. Mounting points are specific to the P407; other boards may require adjustments.
